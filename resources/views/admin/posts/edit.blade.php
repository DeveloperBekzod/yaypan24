                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-header-form">
                                    @can('create post')
                                        <a href="{{ route('admin.posts.create') }}" class="btn btn-primary float-right">Create
                                            new
                                            post</a>
                                    @endcan
                                    <a href="{{ route('admin.posts.index') }}" class="btn mr-2 btn-dark float-right">Go
                                        Back</a>
                                </div>
                            </div>
                            <div class="card-body">
                                <form method="POST" action="{{ route('admin.posts.update', $post->id) }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="title_uz" type="text" name="title_uz"
                                            class="form-control @error('title_uz') is-invalid @enderror"
                                            value="{{ $post->title_uz }}" required>
                                        @error('title_uz')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="title_ru" type="text" name="title_ru"
                                            class="form-control @error('title_ru') is-invalid @enderror"
                                            value="{{ $post->title_ru }}" required>
                                        @error('title_ru')
                                            <span class="invalid-feedback" role="alert">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <label class="custom-switch mt-2">
                                            <input type="checkbox" name="is_special" value="1"
                                                @if ($post->is_special) checked @endif
                                                class="custom-switch-input">
                                            <span class="custom-switch-indicator"></span>
                                            <span class="custom-switch-description">This post shows on the top of home
                                                page</span>
                                            @error('is_special')
                                                <span class="invalid-feedback" role="alert">{{ $message }}</span>
                                            @enderror
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="meta_title_uz" type="text"
                                                name="meta_title_uz" value="{{ $post->meta_title_uz }}"
                                                class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="meta_title_ru">Meta Title Ru</label>
                                            <input class="form-control" id="meta_title_ru" type="text"
                                                name="meta_title_ru" value="{{ $post->meta_title_ru }}"
                                                class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="meta_keywords_uz">Meta Keywords Uz</label>
                                            <input class="form-control" type="text" id="meta_keywords_uz"
                                                name="meta_keywords_uz" value="{{ $post->meta_keywords_uz }}"
                                                class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="meta_keywords_ru">Meta Keywords Ru</label>
                                            <input class="form-control" type="text" id="meta_keywords_ru"
                                                value="{{ $post->meta_keywords_ru }}" name="meta_keywords_ru"
                                                class="form-control">
                                        </div>
                                        <div class="form-group">
