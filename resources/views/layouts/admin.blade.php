      ...
      <nav class="navbar navbar-expand-lg main-navbar sticky">
        ...
        <ul class="navbar-nav navbar-right">
          <li class="dropdown dropdown-list-toggle"><a href="#" data-toggle="dropdown"
              ...
              <span class="badge headerBadge1">{{count($messages)}}</span> </a>
								...
								@forelse ($messages as $message)
									<a href="#" class="dropdown-item">
										<span class="dropdown-item-avatar text-white">
											<img alt="image" src="/admin/assets/img/users/user-1.png" class="rounded-circle">
										</span>
										<span class="dropdown-item-desc"> 
											<span class="message-user">{{ $message->name}}</span>
											<span class="time messege-text">{{ \Str::limit($message->message, 50)}}</span>
											<span class="time">{{$message->created_at->diffForHumans() }}</span>
										</span>
									</a> 
									
								@empty
									<span class="text-info">No messages yet</span>
								@endforelse
              </div>
